                ...
                <div class="row">
                    <div class="col-12 col-md-7">
                        <div class="card rounded-lg">
                            ...
                            <div class="card-body">
                                <form class="" action="{{ route('admin.products.update', $product) }}" method="post"
                                    id="storeProduct">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="description" id='description' rows="8" cols="80" {{ stimulus_controller('ckeditor') }}>{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="card rounded-lg">
                            ...
                            <div class="card-body">
                                <div class="form-group" data-controller="filepond"
                                    ...
                                    <template data-filepond-target="template">
                                        <input data-filepond-target="upload" type="hidden" name="NAME"
                                            form="storeProduct" value="VALUE">
                                    </template>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card rounded-lg">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input form="storeProduct" type="text" name="price" id='price'
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input form="storeProduct" type="text" name="discounted_price"
                                                id='discounted_price' placeholder="0.00"
                                ...
                                <div class="form-group">
                                    <label class="form-label" for='cost'>Cost per item</label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input form="storeProduct" type="text" name="cost" id='cost'
                                            placeholder="0.00" class="form-control @error('cost') is-invalid @enderror"
                        ...
                        <div class="card rounded-lg" data-controller="inventory">
                            <div class="card-header">
                                <h4>Inventory</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input id='sku' form="storeProduct" type="text" name="sku"
                                ...
                                <div class="form-group mb-3">
                                    <label class="custom-switch pl-0">
                                        <input form="storeProduct" checked type="checkbox" @checked(old('track_quantity', $product->track_quantity))
                                            name="track_quantity" data-action="input->inventory#toggle"
...
@enderror">
                                ...
                                <div class="form-group" data-inventory-target="checkbox">
                                    <label class="custom-switch pl-0">
                                        <input form="storeProduct" @checked(old('sell_out_of_stock', $product->sell_out_of_stock)) type="checkbox"
...
@enderror">
                                ...
                                <div class="form-group" data-inventory-target="quantity">
                                    <label class="form-label" for='quantity'>Quantity</label>

                                    <input form="storeProduct" type="text" name="quantity" id='quantity'
                    ...
                    <div class="col-12 col-md-5">
                        <div class="card rounded-lg">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <select form="storeProduct" name="status"
                                        class="form-select @error('status') is-invalid @enderror">
                                        <option value="draft" @selected(old('status', $product->status) == 'draft')>Draft</option>
                                        <option value="review" @selected(old('status', $product->status) == 'review')>Review</option>
                        ...
                        <div class="card rounded-lg">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select form="storeProduct" name="category_id" id='category_id'
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group text-right">
                            <input type="submit" class="btn btn-primary btn-lg" value="Save" form="storeProduct">
                        </div>
                    </div>
                </div>
