                            ...
                            <div class="card-body">
                                <form class="" action="{{ route('admin.products.store') }}" method="post"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="description" id='description' rows="8" cols="80" {{ stimulus_controller('ckeditor') }}>{{ old('description') }}</textarea>
                        ...
                        <div class="card rounded-lg">
                            ...
                            <div class="card-body">
                                ...
                                @foreach (old('images', []) as $image)
                                    <input data-filepond-target="upload" type="hidden" name="images[]" form="storeProduct"
                                        value="{{ $image }}">
                                @endforeach

                                <template data-filepond-target="template">
                                    <input data-filepond-target="upload" type="hidden" name="NAME" form="storeProduct"
                                        value="VALUE">
                                </template>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    <label class="custom-switch pl-0">
                                        <input form="storeProduct" checked type="checkbox" name="track_quantity"
...
@enderror">
                                ...
                                <div class="form-group" data-inventory-target="checkbox">
                                    <label class="custom-switch pl-0">
                                        <input form="storeProduct" type="checkbox" name="sell_out_of_stock"
